      ...
      case 3:
        return (
          <div className="space-y-8">
            ...
            {/* Basic Configuration */}
            <div className="space-y-6">
              <h4 className="text-lg font-medium text-gray-900">Basic Configuration</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Agent group assigned to handle this campaign
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Number of simultaneous calls per available agent
                  </p>
                </div>
              </div>
            </div>
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="flex items-center">
                ...
                <span className={`ml-2 text-sm font-medium ${
                  ...
                  {step === 1 ? 'Basic Info' : step === 2 ? 'Schedule' : 'Configuration'}
                </span>
                {step < 3 && (
