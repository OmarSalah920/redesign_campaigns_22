                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-lg">
                        ...
                        {!formData.ivr ? (
                          <div className="relative group">
                            ...
                            {/* Tooltip */}
                            <div className="absolute w-60 bottom-full left-1/2 transform -translate-x-[calc(100%+5px)] mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-normal break-words z-10">
